# -*- coding: utf-8 -*-
"""
Created on Thu Jul 22 11:07:53 2021
...
# We have divide it with number of matches to make avg. danger passes
...
fig.savefig('./HeatmapOfPasses' + team_required + '.pdf', dpi=None, bbox_inches="tight") 
...
dangerous_player = passes.player_name.value_counts()
print(dangerous_player)
